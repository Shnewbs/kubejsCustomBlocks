...
StartupEvents.registry("block", (event) => {
    ...
    function capfirst(str) {
      ...
      const StoneTypes = ["gnome.metal.light.gray","gnome.metal.gray","gnome.metal.black","gnome.metal.lime","gnome.metal.yellow","gnome.metal.orange","gnome.metal.red","gnome.metal.pink","gnome.metal.magenta","gnome.metal.purple","gnome.metal.blue","gnome.metal.light.blue","gnome.metal.cyan","gnome.metal.green"]
      const StoneVarient = [""]
      ...
      event.create(`${StoneTypes}.block`, 'cardinal')
      .displayName(` ${displayType} Block`) // Set a custom name // Create a new block
      .soundType("stone") // Set a material (affects the sounds and some properties)
      .hardness(1.0) // Set hardness (affects mining time)
      .resistance(1.0) // Set resistance (to explosions, etc)
      .textureAll(`kubejs:block/wcraft/block/metal/${StoneTypes}`)
      .modelJson = {
        parent: `kubejs:block/parent/block`,
        textures: {
            texture: `kubejs:block/wcraft/block/metal/${StoneTypes}`,
            particle: `kubejs:block/wcraft/block/metal/${StoneTypes}`
            }}
        })
...
StoneTypes.forEach(StoneTypes => {
 ...
 event.create(`${StoneTypes}.arch.small.half`, 'cardinal')
     .displayName(` ${displayType} Small Arch Half`) // Set a custom name // Create a new block
     .soundType("stone") // Set a material (affects the sounds and some properties)
     .hardness(1.0) // Set hardness (affects mining time)
     .resistance(1.0) // Set resistance (to explosions, etc)
...
StoneTypes.forEach(StoneTypes => {
 ...
 event.create(`${StoneTypes}.capital.base`, 'cardinal')
     .displayName(` ${displayType} Capital Base`) // Set a custom name // Create a new block
     .soundType("stone") // Set a material (affects the sounds and some properties)
     .hardness(1.0) // Set hardness (affects mining time)
     .resistance(1.0) // Set resistance (to explosions, etc)
     .box(4, 8, 4, 12, 16, 12)
...
StoneTypes.forEach(StoneTypes => {
 ...
 event.create(`${StoneTypes}.capital`, 'cardinal')
     .displayName(` ${displayType} Capital`) // Set a custom name // Create a new block
     .soundType("stone") // Set a material (affects the sounds and some properties)
     .hardness(1.0) // Set hardness (affects mining time)
     .resistance(1.0) // Set resistance (to explosions, etc)
     .box(0, 8, 0, 16, 16, 16) 
...
StoneTypes.forEach(StoneTypes => {
 ...
 event.create(`${StoneTypes}.window`, 'cardinal')
     .displayName(` ${displayType} Window`) // Set a custom name // Create a new block
     .soundType("stone") // Set a material (affects the sounds and some properties)
     .hardness(1.0) // Set hardness (affects mining time)
     .resistance(1.0) // Set resistance (to explosions, etc)
     .box(0, 0, 0, 4, 16, 4)
 ...
 event.create(`${StoneTypes}.window.half`, 'cardinal')
     .displayName(` ${displayType} Half Window`) // Set a custom name // Create a new block
     .soundType("stone") // Set a material (affects the sounds and some properties)
     .hardness(1.0) // Set hardness (affects mining time)
     .resistance(1.0) // Set resistance (to explosions, etc)
     .box(0, 0, 0, 4, 16, 4)
 ...
 event.create(`${StoneTypes}.balustrade.base`, 'cardinal')
     .displayName(` ${displayType} Balustrade Base`) // Set a custom name // Create a new block
     .soundType("stone") // Set a material (affects the sounds and some properties)
     .hardness(1.0) // Set hardness (affects mining time)
     .resistance(1.0) // Set resistance (to explosions, etc)
     .box(2, 0, 2, 14, 4, 14)
 ...
 event.create(`${StoneTypes}.balustrade`, 'cardinal')
     .displayName(` ${displayType} Balustrade`) // Set a custom name // Create a new block
     .soundType("stone") // Set a material (affects the sounds and some properties)
     .hardness(1.0) // Set hardness (affects mining time)
     .resistance(1.0) // Set resistance (to explosions, etc)
     .box(2, 0, 2, 14, 4, 14)
...
StoneTypes.forEach(StoneTypes => {
 ...
 event.create(`${StoneTypes}.eighth.slab`, 'cardinal')
     .displayName(` ${displayType} Eighth Slab`) // Set a custom name // Create a new block
     .soundType("stone") // Set a material (affects the sounds and some properties)
     .hardness(1.0) // Set hardness (affects mining time)
     .resistance(1.0) // Set resistance (to explosions, etc)
     .box(0, 0, 0, 8, 8, 8)
...
StoneTypes.forEach(StoneTypes => {
 ...
 event.create(`${StoneTypes}.stairs`, 'cardinal')
     .displayName(` ${displayType} Stairs`) // Set a custom name // Create a new block
     .soundType("stone") // Set a material (affects the sounds and some properties)
     .hardness(1.0) // Set hardness (affects mining time)
     .resistance(1.0) // Set resistance (to explosions, etc)
     .box(0, 0, 0, 16, 8, 16)
...
StoneTypes.forEach(StoneTypes => {
 ...
 event.create(`${StoneTypes}.pillar`, 'cardinal')
     .displayName(` ${displayType} Pillar`) // Set a custom name // Create a new block
     .soundType("stone") // Set a material (affects the sounds and some properties)
     .hardness(1.0) // Set hardness (affects mining time)
     .resistance(1.0) // Set resistance (to explosions, etc)
     .box(4, 0, 4, 12, 16, 12)
...
event.create(`${StoneTypes}.arch.small`, 'cardinal')
    .displayName(` ${displayType} Small Arch`) // Set a custom name // Create a new block
    .soundType("stone") // Set a material (affects the sounds and some properties)
    .hardness(1.0) // Set hardness (affects mining time)
    .resistance(1.0) // Set resistance (to explosions, etc)
...
event.create(`${StoneTypes}.${StonePathway}`, 'cardinal')
    .displayName(` ${displayType} ${displayPathway}`) // Set a custom name // Create a new block   
    .soundType("stone") // Set a material (affects the sounds and some properties)
    .hardness(1.0) // Set hardness (affects mining time)
    .resistance(1.0) // Set resistance (to explosions, etc)     
    .defaultCutout()
